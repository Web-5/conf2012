		...
		switch(currentPage){
			case "":
                ...
                var speakerList = [{
                        ...
                        theme: "JavaScript",
                        topic: "State of the art: Server-Side JavaScript",
                        link: "AlexandreMorgaut",
                        image: "alexandremorgaut.png"
                    }, {
                        ...
                        name: "Jerome Etienne",
                        theme: "WebGL",
                        topic: "tQuery.js 'three.js power + jQuery API Usability' or how to make a WebGL game in less than 10min",
                        link: "JeromeEtienne",
                        image: "jetienne.jpg"
                    }, {
                    ...
                    for(var i = 0; i < speakerList.length; i++){
                        var divContent = "<a href=\"" + location.pathname + "speakers.html#" + speakerList[i].link + "\" title=\"" 
                            ...
                            + "<br/><img src=\"" + (pageLocale == "en" ? "../" : "") + "images/avatars/small/" + speakerList[i].image + "\" alt=\"" + speakerList[i].topic + "\" width=\"50\" height=\"50\"/></a>",
